                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="memid" type="text" class="form-control" name="memid" value="{{ $user->memid }}" required autofocus>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="pincode" type="text" class="form-control @error('pincode') is-invalid @enderror" name="pincode" value="{{ $user->pincode }}"  autofocus>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="accno" type="text" class="form-control @error('accno') is-invalid @enderror" name="accno" value="{{ $user->accno }}"  autofocus>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="bankname" type="text" class="form-control @error('bankname') is-invalid @enderror" name="bankname" value="{{ $user->bankname }}"  autofocus>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="ifsccode" type="text" class="form-control @error('ifsccode') is-invalid @enderror" name="ifsccode" value="{{ $user->ifsccode }}"  autofocus>
