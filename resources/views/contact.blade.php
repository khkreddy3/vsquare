		  ...
		  <div class="row">
			<!-- Map Column -->
				...
				<div class="col-lg-4 mb-4 contact-right">
					...
					<p>
						Plot no-24/p, Beside Srujana Hospital,<br>Ganesh Nagar, Quthbullapur Road, Hyderabad.
						<br>
					</p>
					<p>
						<abbr title="Phone">P</abbr>: +91 99517 90017
					</p>
					<p>
						<abbr title="Email">E</abbr>:
						<a href="mailto:info@vsquarecap.com"> info@vsquarecap.com </a>
					</p>
					<p>
